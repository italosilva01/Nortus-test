...
"[project]/apps/frontend/shared/lib/api.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
api.interceptors.response.use((response)=>{
    ...
    if ((errorStatus === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$shared$2f$lib$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HTTP_STATUS_CODES"].UNAUTHORIZED || errorStatus === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$shared$2f$lib$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HTTP_STATUS_CODES"].FORBIDDEN) && !originalRequest?._retry) {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$shared$2f$lib$2f$endpoints$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["endpoints"].auth.refreshToken(refreshToken);
...
const authEndpoints = {
    ...
    getCustomerMapData: async ()=>{
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$shared$2f$lib$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get('/map');
        } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2927245d._.js.map
...
"[project]/apps/frontend/shared/lib/api.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const authEndpoints = {
    ...
    getCustomerMapData: async ()=>{
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$shared$2f$lib$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].get('/map.json');
        } catch  {
    ...
    getTicketManagementData: async ()=>{
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$shared$2f$lib$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].get('/ticket-management.json');
        } catch  {

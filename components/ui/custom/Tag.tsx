...
export type TagVariants = 'medium' | 'low' | 'open' | 'inProgress' | 'solved' | 'urgent' | 'secondary' | 'default';
...
const TagVariantsMapping: Record<TagVariants, {classname: string, name: string}> = {

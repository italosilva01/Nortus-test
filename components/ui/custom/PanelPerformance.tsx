        ...
        <Panel className="">
            <CardHeader className="px-6">
                <CardTitle className="flex items-center gap-2">
                    <Typography fontFamily="montserrat" fontWeight="normal" className="text-[14px]" fontColor="title">
                        {title}
                    </Typography>
                </CardTitle>
            </CardHeader>
            <CardContent className="flex flex-col px-6 gap-4 ">
                ...
                <Typography fontFamily="montserrat" fontWeight="normal" className={cn("text-[14px] mt-1 text-sm", positive ? "text-green-600" : "text-red-600")} element="p" fontColor="title">
                    {diffLastMonth}
                </Typography>
            </CardContent>
